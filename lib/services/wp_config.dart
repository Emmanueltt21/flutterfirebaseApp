class WpConfig {
  ...
  // YOUR WEBISTE URL
  static const String websiteUrl = "https://oblimieh.decco22.com";
  ...
  static const int videoTagId = 12;
    ...
    static const String jwtTokenPrivateKey = "dS*<9l3XareS7&-<4-(x}}e7_rS.e&Gx=v{?S -9`q+;7lfeuI0N+O}kO.3]fuzy";
...
// API Routes
  ...
  static const String signUp = 'digitalbank/createSouscription';
  static const String getAgencies = 'digitalbank/getAgencies';
  // static const String login = 'digitalbank/loginCli';     //OLD LOGIN
  static const String login = 'auth/loginCli';
  static const String authToken = 'auth/authenticate';
